...
nepieciešams nospiest pogu , tiks atvērts jauns logs:
...
`Partneriem`_, sadaļā "Pārējie dati":
...
Nospiežot pogu , dati tiks saglabāti un CRM (Partneru) atskaitē `Visi
partneri`_, kā arī citās atskaitēs (Tā piemēram,Virsgrāmatas
atskaitēs->`Konta izraksts`_, u.c. (datu atlases kritērijus atzīmējot
papildus filtrā)) datus būs iespējams atlasīt Sektoru klasifikatora
griezumā.
