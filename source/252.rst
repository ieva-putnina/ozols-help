...
tiks saglabāts un būs pieejams apskatei/labošanai `Kultūras un citu
pasākumu ieejas biļešu žurnālā`_.
...
funkciju , iespēja atvērt Ieņēmumu dokumentu - `Kases ieņēmumu
orderi`_, kuram izvēlētās ieejas biļetes ir piesaistītas:
...
Instrukcija: `Kultūras un citu ieejas biļešu piesaistīšana kases
ieņēmumu orderim`_
...
aprakstu, kurš pieejams apskatei/labošanai `Kultūras un citu pasākumu
ieejas biļešu žurnālā`_. Lai labotu pievienoto ierakstu, Kultūras un
citu pasākumu ieejas biļešu žurnālā jāizmanto komandpoga (ALT+A),
...
biļetes iespējams piesaistīt `Kases ieņēmumu orderim`_.
