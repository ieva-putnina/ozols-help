...
(>Konfigurācija > Iestādījumi > Kopīgie > :doc:`Noliktava<716>`).Ņemot
vērā nomenklatūras koda veidošanas nosacījumus, tiek automatizēti
izveidots nomenklatūras apraksta laukā Kods.
...
norādot atbilstošo pārdošanas cenu izvēlētajam :doc:`Cenu
veidam<105>`:
...
izvēloties dokumentu :doc:`Nomenklatūras atlikumi perioda
sākumā<107>`, gan arī pievienojot atlikumus nomenklatūras kartiņā.
