...
žurnāls un komanda vai arī jāizvēlas Norēķini->Jauns->Pārdošanas
dokuments un tiks atvērts jauns pārdošanas dokuments:
...
nepieciešams izmantot komandu un tiks atvērts pārdošanas satura logs:
...
saglabātu satura ierakstu, jāizmanto komanda vai komanda lai atceltu
satura ieraksta rindu. Dokumenta saturs var sastāvēt no vairākiem
satura ierakstiem, kas kopsummā veido dokumenta Virsrakstā norādīto
summu. Lai pievienotu nākamo satura ierakstu, jāizmanto komanda .
...
skatīt :doc:`Dokumentu grāmatošanas principi<14044>` .
