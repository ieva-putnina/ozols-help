...
norēķinu dokumentu ērtākai grāmatošanai:
...
Konfigurācija->Iestādījumi->Kopīgie-> :doc:`Virsgrāmatas atskaišu
konfigurācijas<179>`
...
Pamatlīdzekļi->Saraksti-> :doc:`Pamatlīdzekļu objekti<202>`
...
kas tiks izmantots atskaišu ģenerēšanai:
Alga->Konfigurācija-> :doc:`Kolonnu virsraksti<214>`
